###
	...
	Creation Date: 2014.11.17 13:15 PM ( Tony ).

	Last Update: 2014.11.21 15:58 PM ( Tony ).    ...//TODO: Update the 'Last Update'.
...
define ['require', 'common'], (require, common) ->

	require ['web.starter.kit-war.machine/logic/index.logic']
